...
syn keyword gradleProjectProperty defaultTasks description extensions gradle syn keyword gradleProjectProperty group logger logging name parent path
...
set foldlevel=20
set sw=2 et
set indentexpr=GetGroovyIndent()
